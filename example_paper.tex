...
\begin{figure}[t!]
  ...
  \caption{Test-other WER vs.\ labeled fine-tuning data on LibriSpeech.
    ...
    low-resource regime (shaded band). At 960h, where dense supervision
    already dominates, the gain disappears.}
