...
#SBATCH --mem=256G
#SBATCH --gres=gpu:2
#SBATCH -o /valhalla/projects/bg-eng-01/LoreaEnc/logs/csu_ctc150.%j.out
#SBATCH -e /valhalla/projects/bg-eng-01/LoreaEnc/logs/csu_ctc150.%j.err
...
OUTPUT_DIR="outputs/causal_specunit/ctc_ssl_150ep_c8"
...
echo "Job ${SLURM_JOB_ID} CTC fine-tuning starting at $(date)"
