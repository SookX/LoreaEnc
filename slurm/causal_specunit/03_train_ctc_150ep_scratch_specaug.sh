...
#SBATCH --job-name=csu_ctc960_scratch_aug
...
#SBATCH --mem=256G
#SBATCH --gres=gpu:2
#SBATCH -o /valhalla/projects/bg-eng-01/LoreaEnc/logs/csu_ctc960_scratch_aug.%j.out
#SBATCH -e /valhalla/projects/bg-eng-01/LoreaEnc/logs/csu_ctc960_scratch_aug.%j.err
...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/causal_specunit/ctc_scratch_960h_specaug_w10_p50_150ep_c8}"
...
echo "Job ${SLURM_JOB_ID} final 960h scratch SpecAug CTC training starting at $(date)"
...
echo "LR=${LR} warmup=${WARMUP_EPOCHS} hold=${PEAK_EPOCHS} decay=${NOAM_DECAY_RATE}"
...
echo "Job ${SLURM_JOB_ID} final 960h scratch SpecAug CTC training finished at $(date)"
