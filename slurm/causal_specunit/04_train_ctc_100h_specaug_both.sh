...
#SBATCH --job-name=csu_ctc100h_aug_both
...
#SBATCH --mem=256G
#SBATCH --gres=gpu:2
#SBATCH -o /valhalla/projects/bg-eng-01/LoreaEnc/logs/csu_ctc100h_aug_both.%j.out
#SBATCH -e /valhalla/projects/bg-eng-01/LoreaEnc/logs/csu_ctc100h_aug_both.%j.err
...
SCRATCH_OUTPUT_DIR="${SCRATCH_OUTPUT_DIR:-outputs/causal_specunit/ctc_scratch_100h_specaug_w10_p50_100ep_c8}"
SSL_OUTPUT_DIR="${SSL_OUTPUT_DIR:-outputs/causal_specunit/ctc_ssl_100h_specaug_elr5e4_w10_p50_100ep_c8}"
...
echo "Job ${SLURM_JOB_ID} 100h SpecAug CTC comparison starting at $(date)"
...
echo "Starting scratch SpecAug run at $(date)"
torchrun \
...
echo "Starting SSL SpecAug run at $(date)"
...
echo "Job ${SLURM_JOB_ID} 100h SpecAug CTC comparison finished at $(date)"
echo "Metrics:"
