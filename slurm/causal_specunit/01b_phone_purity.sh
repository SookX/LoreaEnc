...
echo "Phase 1/2: phone purity including silence -> ${OUTPUT_PATH}"
...
echo "Phase 2/2: phone purity excluding silence -> outputs/causal_specunit/phone_purity_c8_no_silence.npz"
