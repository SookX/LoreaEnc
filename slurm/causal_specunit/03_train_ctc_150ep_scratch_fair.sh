...
#SBATCH --job-name=csu_ctc960_scratch_fair
...
#SBATCH --mem=256G
#SBATCH --gres=gpu:2
#SBATCH -o /valhalla/projects/bg-eng-01/LoreaEnc/logs/csu_ctc960_scratch_fair.%j.out
#SBATCH -e /valhalla/projects/bg-eng-01/LoreaEnc/logs/csu_ctc960_scratch_fair.%j.err
...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/causal_specunit/ctc_scratch_960h_specaug_fair_elr3e4_hlr1e3_w10_p50_150ep_c8}"
...
echo "Job ${SLURM_JOB_ID} scratch-only fair 960h/150ep SpecAug CTC training starting at $(date)"
...
echo "Job ${SLURM_JOB_ID} scratch-only fair 960h/150ep SpecAug CTC training finished at $(date)"
